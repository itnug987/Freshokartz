...
import com.freshokartz.ProductsPrime;
...
import com.freshokartz.ActivityOrderHistory;
...
import com.freshokartz.adapter.Adapter_past_order_items;
...
public class CartItemsAdapter extends RecyclerView.Adapter<CartItemsAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, final int position) {
        ...
        viewHolder.title.setText(c.getSku());
